 ...
 */
public class LocaleTestGwt extends GWTTestCase {
    ...
    protected void gwtSetUp() {
        ...
        locale.country = "DE";
        locale.language = "en";
        repository.add("<locale><id>123</id><created_at>2009-07-09T17:14:48+05:30</created_at></locale>",
                1);
        locale.save();
        repository.reset();
    }
    ...
    public void testRetrieve() {
        ...
        Resource<Locale> l = factory.get(1,
                new ResourceChangeListener<Locale>() {
